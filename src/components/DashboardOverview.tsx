...
export const DashboardOverview: React.FC<DashboardOverviewProps> = ({
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="flex items-center gap-3 rounded-xl bg-slate-900/90 px-4 py-2.5 border border-slate-800 shadow-lg shadow-slate-950/40">
        <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-indigo-500/20 text-indigo-400">
          <Activity className="h-3.5 w-3.5 animate-pulse" />
        </div>
        <div className="text-xs font-semibold text-slate-300">Live Grid News:</div>
        <div className="flex-1 overflow-hidden">
          <div className="inline-flex animate-marquee items-center gap-8 whitespace-nowrap text-xs text-slate-400">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 relative z-10">
          <div className="space-y-2">
            <div className="inline-flex items-center gap-2 px-2.5 py-1 rounded-full bg-indigo-500/10 text-indigo-400 text-xs font-semibold border border-indigo-500/20">
              ...
              Fully Industry Ready Heavy Infrastructure
            </div>
